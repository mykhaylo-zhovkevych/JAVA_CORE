...
public class LifeApp implements Runnable {
    ...
    private static final int BOARD_WIDTH = 1300;  // Breite des Spielfeldes
    private static final int BOARD_HEIGHT = 700; // Höhe des Spielfeldes
    ...
    public void run() {
        ...
        frame.setResizable(true); // Fenstergröße nicht veränderbar
        frame.setTitle("Game Of Life"); // Titel des Fensters
